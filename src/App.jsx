...
const SEED_CARS_DETAILED = [
  ...
  // após o usuário notar que a linha BYD estava incompleta.
  {
    id: "byd-atto-8",
    name: "BYD Atto 8",
    brand: "BYD",
  ...
  },
  {
    ...
    consumptionKwh100: null,
    techNotes:
      "Primeiro SUV híbrido plug-in fabricado no Brasil pela BYD — motor 1.5 Flex (etanol ou gasolina) + elétrico somando 235cv e ~30,5 kgfm. Autonomia elétrica pura de até 72km (versão GS) e autonomia total combinada de até 1.105km. Preço de R$176.990 é da versão de entrada GL (já com desconto de venda direta); a versão GS sai por R$199.990.",
  ...
  },
  {
    ...
    techNotes:
      "SUV elétrico premium de 7 lugares, tração integral 4x4, 517cv e 700Nm, acelera de 0-100km/h em menos de 5s. Bateria Blade LFP gigante de 108,8kWh rende até 430km Inmetro (530km no ciclo WLTP, mais otimista). Porta-malas varia de 235L (7 lugares) a 940L (5 lugares) e 1.655L com os bancos rebatidos. Recarga DC de 30-80% em ~30min a 110kW. Preço não incluído: fontes divergem entre R$529.890 e R$536.800 e não conseguimos confirmar o valor exato de tabela atual — confira na concessionária.",
  ...
  },
  {
    ...
    batteryKwh: 18,
    batteryChem: null,
    motorType: "PHEV combinado (1.5 aspirado 98cv + elétrico 197cv) — FWD",
    rangeKm: 1000,
    accel: 7.5,
    groundClearance: null,
    trunkL: 440,
    ...
    consumptionKwh100: null,
    techNotes:
      "SUV híbrido plug-in listado no site oficial da BYD Brasil, mas ainda sem preço oficial confirmado publicamente (estimativa de mercado entre R$180-220 mil) — não incluímos preço pra não arriscar um valor errado. Motor 1.5 aspirado (98cv) + elétrico (197cv), somando 212cv e ~30,6 kgfm. Bateria de 18kWh rende até 110km no ciclo chinês NEDC (na prática, algo entre 80-100km em condições brasileiras). Autonomia combinada acima de 1.000km. Recarga DC (60kW) de 30-80% em 30-40min.",
    personas: { urbano: 4, familia: 3, aventura: 2, performance: 2, custo: 4 },
  },
  {
    id: "mg-mg4",
    name: "MG4 Comfort",
  ...
  },
  {
    ...
    techNotes:
      "Versão Pro (R$205.800) tem autonomia de 413km; a Max (R$225.800) cai pra 349km com mais equipamentos. Existe também a versão híbrida plug-in EX5 EM-i (a partir de R$189.990, sistema Super Híbrido 262cv combinados, bateria 29,8kWh, ~112km de autonomia elétrica Inmetro na versão Ultra, autonomia combinada de 1.300km).",
