...
const SEED_CARS_DETAILED = [
  ...
  },
  {
    ...
    maintenanceTotalCost: null,
    consumptionKwh100: null,
    videoUrl: "https://www.youtube.com/watch?v=qrhaXFjhYTw",
    techNotes:
      "Correção em 19/08/2026: a GWM descontinuou as versões Skin BEV48 e GT BEV63 e unificou a linha Ora 03 num único trim, o BEV58 (bateria de 58kWh) — algumas unidades das versões antigas ainda podem estar em estoque em concessionárias, mas não são mais o catálogo oficial. O BEV58 herdou detalhes visuais que eram exclusivos da GT (pinças de freio pintadas, cores exclusivas), já representando ~80% das vendas da linha antes da unificação. Ficha técnica do catálogo oficial (ano-modelo 26/27): 171cv/250Nm, 0-100 em 9,0s, 315km de autonomia Inmetro (420km WLTP), entre-eixos de 2,65m, 7 airbags, porta-malas de 228L (858L com banco traseiro rebatido) + frunk dianteiro. Recarga AC em ~5h30 (15-100%) e DC em ~42min (30-80%) — potência exata em kW não confirmada em fonte oficial. Garantia e wallbox incluso não confirmados em fonte disponível.",
  ...
  },
  {
    ...
    techNotes:
      "Versão de bateria maior do Haval H6 PHEV (a versão PHEV19, com bateria de 19kWh e 326cv, já está cadastrada separadamente, id gwm-haval-h6-phev): aqui a bateria de 35kWh e o sistema Hi4 com tração integral (motor elétrico em cada eixo) elevam a potência para 393cv/642Nm (torque corrigido em 19/08/2026 — página oficial confirma 642Nm/65,5kgf.m, o valor anterior de 762Nm estava errado). Preço atualizado pra R$290.000 (site oficial). Autonomia elétrica pura confirmada em fonte oficial: 126km Inmetro / até 180km WLTP. Existe também a versão GT (mesma mecânica 393cv/642Nm, suspensão mais esportiva, R$326.000 confirmado no site oficial), não cadastrada separadamente por não ter diferença de potência/bateria da PHEV35, só de calibração de suspensão e equipamentos — mesmo critério já usado nesta base pra casos parecidos.",
  ...
  },
  {
    ...
    techNotes:
      "Preço de R$269.800 é o que constava na ficha original desta versão Design/RWD (313cv) — vale reconferir: em 20/08/2026 o site oficial BYD (byd.com/br/car/seal e o configurador /br/order-seal) só menciona a versão AWD/Performance (530cv, cadastrada separadamente), o que sugere que a Design pode ter saído de linha no Brasil. Autonomia real PBEV/Inmetro de 372km é bem mais conservadora que os 570km que circulavam antes (provavelmente CLTC chinês).",
  ...
  },
  {
    ...
    dcKw: null,
    airbags: 6,
    warranty: "Não confirmado veículo / 8 anos ou 200.000 km bateria",
    fuelType: "BEV",
    verified: true,
    priceVerifiedDate: "20/08/2026",
    maintenanceInterval: null,
    maintenanceFirstCost: null,
    maintenanceKmBase: null,
    maintenanceTotalCost: null,
    consumptionKwh100: 22.2,
    techNotes:
      "Versão de topo do Seal — a 'BYD Seal' (Design/RWD, 313cv) já cadastrada é a de entrada. Specs conferidos na ficha técnica oficial em PDF da BYD (fichas-tecnicas-2026/, edição fev/2026): 530cv/590Nm AWD, bateria Blade LFP de 82,56kWh, 0-100 em 3,8s, 180km/h, recarga DC 30-80% em menos de 30min. Peso de 2.185kg é bem mais alto que o normal pro segmento. Preço R$299.990 é o valor do configurador oficial (byd.com/br/order-seal) em 20/08/2026 — a ficha oficial não lista porta-malas nem potência de carregamento AC/DC separadamente pra essa versão, por isso ficaram em branco em vez de estimados.",
    personas: { urbano: 2, familia: 3, aventura: 3, performance: 5, custo: 1 },
  },
  {
    id: "byd-han-ev",
  ...
  },
  {
    ...
    batteryKwh: 26.6,
    batteryChem: "LFP (Blade)",
    motorType: "PHEV combinado (1.5 turbo 130cv + elétrico dianteiro 204cv) — FWD",
    rangeKm: 1150,
    accel: 8.1,
    groundClearance: 180,
    trunkL: 552,
    ...
    techNotes:
      "Correção em 19/08/2026: linha 2027 trocou o motor 1.5 aspirado por um 1.5 turbo (130cv) e ampliou bastante a bateria (26,6kWh vs 18,3kWh antes), elevando a autonomia elétrica pura pra 99km Inmetro (era 68km) e reduzindo levemente a potência combinada informada (239cv vs 235cv, dentro da margem de arredondamento). Preço oficial atualizado pra R$249.990. Recarga DC de até 18kW, recurso que a geração anterior não tinha. Continua FWD — a versão Premium (AWD, 324cv, R$299.800, cadastrada separadamente, id byd-song-plus-premium-dmi) segue sendo o degrau acima, sem mudanças identificadas na pesquisa.",
  ...
  },
  {
    ...
    techNotes:
      "Preço real de tabela é R$175.990 — bem abaixo dos R$279.800 que circulavam antes. A versão de entrada GL (R$147.990, cadastrada separadamente) tem MENOS potência (209cv) mas bateria MAIOR (8,3kWh) e MAIS autonomia elétrica (50km NEDC) que a GS — o inverso do que uma nota anterior desta ficha dizia (32km), corrigido em 20/08/2026 após conferir a ficha técnica oficial da GL em PDF no site da BYD. Bateria pequena (6,6kWh) é perfil híbrido leve, não plugável de longa autonomia elétrica: até 78km NEDC na GS. Consumo no modo combustão: até 16,8 km/l na cidade.",
    personas: { urbano: 4, familia: 3, aventura: 1, performance: 3, custo: 3 },
  },
  {
    id: "byd-king-phev-gl",
    imageUrl: "https://www.byd.com/material/byd-site/br/product/king/king-Header1.png",
    name: "BYD King PHEV GL",
    brand: "BYD",
    category: "Sedã compacto híbrido",
    price: 147990,
    powerCv: 209,
    ...
    batteryKwh: 8.3,
    batteryChem: "LFP (Blade)",
    motorType: "PHEV combinado (1.5 + elétrico) — versão GL",
    rangeKm: 1175,
    accel: 7.9,
    groundClearance: 120,
    trunkL: 450,
    ...
    dcKw: null,
    airbags: 6,
    warranty: "6 anos/200.000 km veículo / 8 anos/200.000 km bateria",
    fuelType: "PHEV",
    verified: true,
    priceVerifiedDate: "20/08/2026",
    maintenanceInterval: null,
    ...
    consumptionKwh100: null,
    techNotes:
      "Versão de entrada da linha King (distinta da 'BYD King PHEV GS', já cadastrada). Ficha técnica oficial conferida em PDF no site da BYD (fichas-tecnicas-2026/): 209cv combinados (179cv motor elétrico + 110cv motor 1.5 aspirado), 0-100 em 7,9s, 185km/h. Autonomia elétrica NEDC de 50km com bateria Blade de 8,3kWh — maior que a da GS (6,6kWh), o que é incomum pra uma versão de entrada. Carregamento só em AC 3,3kW. Autonomia combinada de 1.175km (mesmo valor da GS, provavelmente mesmo tanque de 48L e motor a combustão). 6 airbags confirmados (2 frontais + 2 laterais dianteiros + 2 cortina).",
    personas: { urbano: 4, familia: 3, aventura: 1, performance: 2, custo: 4 },
  },
  {
    id: "byd-shark-phev",
  ...
  },
  {
    ...
    batteryKwh: 100,
    batteryChem: null,
    motorType: "PMSM traseiro (RWD, monomotor)",
    rangeKm: 491,
    accel: 6.0,
    groundClearance: 172,
    trunkL: 539,
    ...
    consumptionKwh100: 20.4,
    techNotes:
      "Versão de entrada da linha Zeekr 7X (a Flagship, bimotor AWD 646cv, já cadastrada separadamente). Lançada depois da Flagship com foco em autonomia em vez de performance: motor único traseiro de 310kW/421cv e 44,9kgf.m (440Nm), 0-100 em ~6s, mesma bateria de 100kWh mas com mais alcance (491km vs 423km da AWD, por ter só um motor). Preço de pré-venda R$378.000 (jun/2026). Altura livre do solo e porta-malas reaproveitados da Flagship (mesma carroceria, motor RWD único é a única mudança mecânica confirmada) — peso, carregamento AC/DC e garantia não confirmados especificamente pra essa versão.",
    personas: { urbano: 3, familia: 4, aventura: 3, performance: 3, custo: 2 },
  },
  {
    id: "neta-x-400",
  ...
  },
  {
    ...
    techNotes:
      "Baterias fabricadas pela CATL (química LFP). Carregamento AC completo em ~11h; DC de 30% a 80% em ~30min. Existe também a versão 500 Luxury, com peso e bateria equivalentes, cadastrada separadamente. Torque de 210Nm e tração dianteira (FWD) preenchidos em pente-fino 19/08/2026 (mesmo motor em todas as versões da linha X, confirmado em múltiplas fontes).",
    personas: { urbano: 3, familia: 4, aventura: 2, performance: 2, custo: 3 },
  },
  {
    id: "neta-x-500-luxury",
    imageUrl: "https://netaauto.com.br/wp-content/webp-express/webp-images/uploads/2025/06/NETA-X-8.jpg.webp",
    name: "Neta X 500 Luxury",
    brand: "Neta",
    category: "SUV compacto",
    price: 214900,
    powerCv: 163,
    ...
    consumptionKwh100: 20.2,
    techNotes:
      "Topo da linha Neta X — mesmo motor, bateria e autonomia da 'Neta X 500' (já cadastrada), a diferença é equipamento. Peso (1.740kg) idêntico ao da 500 confirma que a mecânica é a mesma. Porta-malas de 508L é específico dessa versão (não confirmado para a 400/500 simples). Preço R$214.900 (R$10.000 a mais que a 500 simples).",
    personas: { urbano: 3, familia: 4, aventura: 2, performance: 2, custo: 3 },
  },
  ...
  },
  {
    ...
    techNotes:
      "Marca inteiramente ausente da base anterior. Grand Cherokee 4xe retornou ao Brasil em 2026 (primeiras 150 unidades importadas dos EUA já entregues às concessionárias), potência/torque combinados oficiais (documento técnico Stellantis): 380cv/637Nm. Preço corrigido em pente-fino 19/08/2026 de R$569.990 para R$549.990 (valor de tabela mais recente, confirmado em release oficial Stellantis de fev/2026; o valor anterior era do primeiro lote importado). Aceleração 0-100 de 6,3s preenchida na mesma revisão. Autonomia elétrica de 29km (Inmetro) — bem abaixo dos 50km divulgados em outros mercados. Só recarrega em AC (até 7,2kW via wallbox tipo 2, ~2h30 para carga completa); não tem porta de recarga DC. Consumo combinado de 19,3 km/l (Inmetro). ATENÇÃO: o Jeep Compass 4xe (outro PHEV da marca) foi pesquisado mas NÃO foi incluído — ainda é vendido (R$349.990) mas está oficialmente fora de linha, aguardando a nova geração do Compass (com PHEV) em 2027; vendeu só ~100 unidades em 2025.",
