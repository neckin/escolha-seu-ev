...
const SEED_CARS_DETAILED = [
  ...
  {
    id: "volvo-es90",
    imageUrl: "https://www.autoshow.com.br/conteudo/not/001/cont/imagens/IMG_5611.webp",
    name: "Volvo ES90 Ultra Twin Motor Performance",
    brand: "Volvo",
    category: "Sedã grande premium",
    price: 659950,
    powerCv: 680,
    ...
    batteryKwh: 106,
    batteryChem: null,
    motorType: "Bimotor AWD (299cv dianteiro + 381cv traseiro)",
    rangeKm: 524,
    accel: 4.0,
    groundClearance: null,
    trunkL: 446,
    ...
    dcKw: 350,
    airbags: 9,
    warranty: "3 anos veículo / 8 anos (160.000 km) bateria",
    fuelType: "BEV",
    verified: true,
    priceVerifiedDate: "03/09/2026",
    maintenanceInterval: null,
    maintenanceFirstCost: null,
    maintenanceKmBase: null,
    maintenanceTotalCost: null,
    consumptionKwh100: 20.2,
    techNotes:
      "Sedã grande 100% elétrico, primeiro da Volvo com arquitetura 800V — estreou no Brasil no Festival Interlagos (ago/2026), já disponível nas 52 concessionárias da marca no país por R$659.950, versão única Ultra Twin Motor Performance. Bimotor AWD de 680cv/870Nm, 0-100km/h em 4,0s, velocidade máxima limitada a 180km/h. Bateria de 106kWh dá 524km de autonomia (ciclo Inmetro/PBEV; WLTP passa de 700km). Recarga DC de até 350kW (10-80% em ~22min, repondo até 300km em 10min). Porta-malas de 446L + porta-malas dianteiro (frunk) de 27L. Coeficiente de arrasto de 0,25 — o menor já registrado pela Volvo. Airbags (9) e config. de porta-malas assumidos iguais ao padrão europeu da linha, por falta de ficha técnica brasileira detalhada publicada até a data de verificação; peso não divulgado.",
    personas: { urbano: 2, familia: 3, aventura: 1, performance: 5, custo: 1 },
  },
  {
