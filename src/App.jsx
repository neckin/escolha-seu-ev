...
const SEED_CARS_DETAILED = [
  ...
  },
  {
    ...
    consumptionKwh100: 14.3,
    techNotes:
      "Versão de entrada da linha MG4 Urban (distinta da 'MG4 Urban Luxury 54 kWh' e da 'MG4 Urban Luxury' 43kWh, cadastradas separadamente). Mesmo motor/bateria/autonomia da Luxury 43kWh — a diferença é só equipamento (rodas de 16' vs 17', sem bancos aquecidos, sem câmera 360°, sem banco do motorista elétrico). Preço R$129.990 conferido na ficha técnica e página de ofertas oficiais MG (ago/2026).",
    personas: { urbano: 5, familia: 4, aventura: 2, performance: 3, custo: 5 },
  },
  {
    id: "mg4urban-luxury43",
    imageUrl: "https://mgmotoroficial.com.br/imagens/new-mg4-urban/banner.jpg",
    name: "MG4 Urban Luxury 43 kWh",
    brand: "MG",
    category: "Hatch médio",
    price: 139990,
    powerCv: 150,
    ...
    consumptionKwh100: 14.3,
    techNotes:
      "Mesmo motor, bateria e autonomia (299km Inmetro) da 'MG4 Urban Comfort', mas com mais equipamento: rodas de liga leve 17', bancos dianteiros aquecidos, volante em couro, luz ambiente 64 cores, câmera 360° (SVM), banco do motorista com ajuste elétrico de 6 posições, vidro traseiro escurecido e retrovisores com rebatimento elétrico automático. Preço R$139.990 conferido na ficha técnica e página de ofertas oficiais MG (ago/2026).",
    personas: { urbano: 4, familia: 5, aventura: 3, performance: 3, custo: 4 },
  },
  {
    id: "mg4urban",
    imageUrl: "https://mgmotoroficial.com.br/imagens/new-mg4-urban/banner.jpg",
  ...
  },
  {
    ...
    techNotes:
      "Versão de entrada da linha MG4 (distinta da 'MG4 Urban', um modelo menor e mais barato, cadastrada separadamente em 3 versões). Luxury RWD 64kWh (mesma potência/bateria/autonomia, mais equipamento) e XPower AWD 64kWh (320kW/435cv, tração integral, 0-100 em 3,8s, R$229.800) agora cadastradas separadamente. Autonomia 364km é a homologada Inmetro/PBEV (a WLTP divulgada pela MG é 467km, mas superestima o uso real no Brasil). Ficha conferida na ficha técnica oficial MG (ago/2026).",
  ...
  },
  {
    ...
    consumptionKwh100: 17.0,
    techNotes:
      "Mesmo motor, bateria e autonomia (364km Inmetro) da 'MG4 Comfort', mas com mais equipamento: smart câmera 360° (SVM), banco do motorista com ajuste elétrico, carregador wireless para celular, monitoramento de ponto cego (BSD) + RCTA + LCA, bancos em tecido e couro artificial, espelho retrovisor interno eletrocrômico, vidros traseiros escurecidos e retrovisores com rebatimento elétrico. Preço R$189.800 é o valor da oferta oficial MG vigente 01–31/08/2026 (de R$199.800); pode mudar em setembro.",
    personas: { urbano: 4, familia: 4, aventura: 2, performance: 4, custo: 3 },
  },
  {
    id: "mg-mg4-xpower",
    ...
    maintenanceKmBase: null,
    maintenanceTotalCost: null,
    consumptionKwh100: 22.1,
    techNotes:
      "Versão de performance da linha MG4: 320kW/435cv, tração integral, 61,2kgf.m de torque, 0-100km/h em 3,8s e velocidade máxima de 200km/h (vs 180km/h nas demais versões). Recarga DC 30-80% em 22min (vs 29min nas outras). Freios a disco ventilados nas 4 rodas, rodas de liga leve 18' exclusivas e bancos em camurça/couro sintético. Autonomia menor (279km Inmetro) é o preço da performance. Preço R$229.800 conferido na página de ofertas oficial MG (ago/2026) — corrige estimativa antiga de R$249.000 que circulava em fontes de mercado.",
    personas: { urbano: 3, familia: 2, aventura: 4, performance: 5, custo: 1 },
  },
  {
    id: "mg-s5",
